...
<link href="/resources/css/mypage/pwdCheck2.css" rel="stylesheet">
...
<div class="contentBoardContainer">
	<div class="title-div">
		<h2 class="first-title">회원정보 수정</h2>
	</div>
	...
	<div class="find-btn">
    	<button type="button" class="ok-btn"  onclick="fn_pageMove('updateForm')">확인</button>
    	<button type="submit" class="cencle-btn">취소</button>
	</div>
